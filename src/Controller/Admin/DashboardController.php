...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('Réservations', 'fa-solid fa-bookmark', Reservation::class)
        ->setController(ReservationCrudController::class);
        yield MenuItem::linkToCrud('Calendriers', 'fa-solid fa-calendar-days', Calendar::class)
